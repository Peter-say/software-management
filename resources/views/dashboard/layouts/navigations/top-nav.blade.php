		...
		***********************************-->
		<div class="nav-header">
			<a href="index.html" class="brand-logo">
				<svg class="logo-abbr" xmlns="http://www.w3.org/2000/svg" width="47.426" height="56.91"
					...
					<g id="Group_25" data-name="Group 25" transform="translate(-56 -32)">
						<path id="hotel"
							...
							transform="translate(16.004 32)" fill="#135846" />
						<path id="hotel-2" data-name="hotel"
							...
							transform="translate(16.004 32)" fill="var(--primary)" />
					</g>
				</svg>
