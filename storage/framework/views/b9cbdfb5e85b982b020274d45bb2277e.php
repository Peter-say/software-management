<?php $__env->startSection('contents'); ?>
        ...
        <div class="container-fluid">
            ...
            <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                ...
                <div class="d-flex justify-content-end">
                    <form method="GET" action="<?php echo e(route('dashboard.hotel.purchases-dashbaord')); ?>" class="d-inline">
                        <div class="dropdown">
                    ...
                    <div class="d-flex align-items-center mb-2">
                        <a href="<?php echo e(route('dashboard.hotel.purchases.index')); ?>" class="btn btn-primary me-2">
                            View List</a>
                    </div>
                    <div class="d-flex align-items-center mb-2">
            ...
            <div class="row">
                <div class="col-xxl-8 col-xl-8 col-md-12 col-sm-12">
                    <div class="row">
                        <?php $__currentLoopData = $purchase_stats['cards']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body">
                                            <table class="table table-striped mb-0">
                                                ...
                                                <tbody>
                                                    <?php $__currentLoopData = $top_purchase; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $top_expense): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr>
                                                            <td><?php echo e($top_expense->category->name); ?></td>
                                                            <td><?php echo e(number_format($top_expense->amount)); ?></td>
                                                        </tr>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </tbody>
                                            </table>
    ...
    <?php echo $__env->make('dashboard.chart.purchases.general', ['purchases_chart_data' => $purchase_chart_data], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <script>
...
<?php echo $__env->make('dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Web Development\Backend\Laravel\software-management\software-management\resources\views\dashboard\hotel\purchases\dashboard.blade.php ENDPATH**/ ?>