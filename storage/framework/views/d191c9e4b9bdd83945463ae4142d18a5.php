            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title"><?php echo e(isset($room) ? 'Update Room' : 'Create Room'); ?></h4>
                    </div>
                    <div class="card-body">
                        <form
                            action="<?php echo e(isset($room) ? route('dashboard.hotel.rooms.update', $room->id) : route('dashboard.hotel.rooms.store')); ?>"
...
unset($__errorArgs, $__bag); ?>" placeholder="Name"
                                            value="<?php echo e(old('name', $room->name ?? '')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" required>
                                            ...
                                            <?php $__currentLoopData = $room_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($type->id); ?>"
                                                    <?php echo e(old('room_type_id', $room->roomType->id ?? '') == $type->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" required>
                                            ...
                                            <?php $__currentLoopData = $statusOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($status); ?>"
                                                    <?php echo e(old('status', $room->status ?? '') == $status ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('description', $room->description ?? '')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <button type="submit"
                                class="btn btn-primary"><?php echo e(isset($room) ? 'Update' : 'Submit'); ?></button>
                        </form>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Web Development\Backend\Laravel\software-management\software-management\resources\views/dashboard/hotel/room/create.blade.php ENDPATH**/ ?>