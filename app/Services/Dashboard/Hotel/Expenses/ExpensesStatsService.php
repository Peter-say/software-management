        ...
        $data = [
            "cards" => [
                ...
                [
                    ...
                    "value" =>  currencySymbol().number_format(array_sum($expenses_data['totalExpensesAmount']), 2),
                    "class" => "primary",
                    'period' =>  $period,
                ],
                [
                    ...
                    "value" => currencySymbol().number_format(array_sum($expenses_data['totalPaidExpenses'])),
                    "class" => "primary",
                    'period' =>  $period,
                ],
                [
                    ...
                    "value" => currencySymbol().number_format(array_sum($expenses_data['totalUnpaidExpenses'])),
                    "class" => "primary",
                    'period' =>  $period,
                ],
