                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="room-list-bx d-flex align-items-center">
                                                                    <img class="me-3 rounded" src="{{ $room->RoomImage() }}" alt="">
                                                                    <div>
                                                            ...
                                                            <td>
                                                                <div class="">
                                                                    ...
                                                                    <span class="font-w500">{{ $room->roomType->rate }}<small class="fs-14 ms-2">/night</small></span>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div>
                                                            ...
                                                            <td>
                                                                <a href="javascript:void(0);" class="btn btn-{{ $room->status == 'active' ? 'success' : 'danger' }} btn-md">
                                                            ...
                                                            <td>
                                                                <div class="dropdown dropend">
                                                                    ...
                                                                    <div class="dropdown-menu">
                                                                        <a class="dropdown-item" href="{{ route('dashboard.hotel.rooms.edit', $room->id) }}">Edit</a>
                                                                        <a class="dropdown-item" href="javascript:void(0);" onclick="confirmDelete('{{ route('dashboard.hotel.rooms.destroy', $room->id) }}')">Delete</a>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
