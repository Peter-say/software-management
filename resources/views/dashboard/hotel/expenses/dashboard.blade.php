...
@section('contents')
        ...
        <div class="container-fluid">
            ...
            <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                ...
                <div class="d-flex justify-content-end">
                    <form method="GET" action="{{ route('dashboard.hotel.expenses-dashbaord') }}" class="d-inline">
                        <div class="dropdown">
            ...
            <div class="row">
                <div class="col-xxl-8 col-xl-8 col-md-12 col-sm-12">
                    <div class="row">
                        @foreach ($expenses_stats['cards'] as $index => $card)
    ...
    @include('dashboard.chart.expenses.general', ['expenses_chart_data' => $expenses_chart_data])
    <script>
