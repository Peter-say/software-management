        ...
        <div class="container-fluid">
            <div class="row page-titles">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="<?php echo e(route('dashboard.hotel.settings.hotel-info.')); ?>">Hotel Info</a></li>
            ...
            <div class="row">
                <div class="col-xl-12 col-xxl-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form
                                action="<?php echo e(isset($selected_modules) ? route('dashboard.hotel.module-preferences.update', Auth::user()->hotel->id) : route('dashboard.hotel.module-preferences.store')); ?>"
                                method="post">
                                <?php echo csrf_field(); ?>
                                <?php if(isset($selected_modules)): ?>
                                ...
                                <div class="row">
                                    ...
                                    <?php $__currentLoopData = $modules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="col-md-4 mb-4">
                                            <div class="card module-card" data-name="<?php echo e($module); ?>"
                                                <?php if(isset($selected_modules) && in_array($module, $selected_modules)): ?> class="selected" <?php endif; ?>>
                                                <div class="card-body text-center">
                                                    <h5 class="card-title"><?php echo e($module); ?></h5>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <input type="hidden" name="selected_modules" id="selected-modules"
                                    value="<?php echo e(isset($selected_modules) ? implode(',', $selected_modules) : ''); ?>">
...
<?php echo $__env->make('dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Web Development\Backend\Laravel\software-management\software-management\resources\views\dashboard\hotel\module-preference\create.blade.php ENDPATH**/ ?>