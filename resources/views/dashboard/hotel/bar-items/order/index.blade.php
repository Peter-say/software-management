            ...
            <div class="container-fluid">
                <div class="mt-4 d-flex justify-content-between align-items-center flex-wrap">
                    ...
                    <div class="d-flex align-items-center mb-2">
                        <a href="{{ route('dashboard.hotel.bar.create-order') }}" class="btn btn-secondary">+ New
                            Order</a>
                                    ...
                                    <div class="tab-pane fade active show" id="AllOrders">
                                        <div class="table-responsive">
                                            <table class="table card-table display mb-4 shadow-hover table-responsive-lg"
                                                ...
                                                <tbody>
                                                    @if ($bar_orders && $bar_orders->count() > 0)
                                                        @foreach ($bar_orders as $order)
                                                            <tr>
                                                                <td>
                                                                    <div class="form-check style-1">
                                                                        <input class="form-check-input" type="checkbox"
                                                                ...
                                                                <td>
                                                                    <div class="d-flex">
                                                                        {{-- Edit Order --}}
                                                                        <a href="{{ route('dashboard.hotel.bar.edit-order', $order->id) }}"
                                                                        ...
                                                                        <a href="javascript:void(0);"
                                                                            ...
                                                                            onclick="confirmDelete('{{ route('dashboard.hotel.bar.destroy-order', $order->id) }}')">
                                                            ...
                                                            @include('dashboard.hotel.bar-items.order.choose-paymet-method-modal',[
                                                                'order' => $order,
                                            ...
                                            @include('dashboard.hotel.bar-items.order.cancel-modal', [
                                                'order' => $order,
                                            ])
                                        ...
                                        <div class="d-flex justify-content-between align-items-center mt-3">
                                            <div class="text-muted">
                                                Showing {{ $bar_orders->firstItem() }} to
                                                {{ $bar_orders->lastItem() }} of {{ $bar_orders->total() }}
                                                entries
                                            </div>
                                            <nav aria-label="Page navigation">
                                                <ul class="pagination">
                                                    {{ $bar_orders->links('pagination::bootstrap-4') }}
                                                </ul>
                                            </nav>
                                        </div>
                                    </div>
