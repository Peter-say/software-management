...
<div class="modal fade" id="upload-items-modal" tabindex="-1" role="dialog" aria-labelledby="upload-items-modal"
    aria-hidden="true">
            ...
            <div class="modal-body">
                <div>
                    <a href="#" class="btn btn-primary" id="downloadSample">
                        <i class="fas fa-download"></i> Download Restaurant Item Sample
                    </a>
...
<script>
    $(document).ready(function() {
        $('#uploadItemsForm').on('submit', function(event) {
            ...
            $.ajax({
                url: '<?php echo e(route('dashboard.hotel.restaurant-items.upload')); ?>', // Your route
                type: 'POST',
                data: formData,
                contentType: false,
                processData: false,
...
<?php /**PATH C:\Web Development\Backend\Laravel\software-management\software-management\resources\views/dashboard/hotel/restaurant-item/upload-modal.blade.php ENDPATH**/ ?>