...
<div class="dlabnav">
     ...
     <?php
          ...
          $hasModules = $hotelUser && $hotelUser->hotel 
                          ...
                          <li>
                                ...
                                <ul aria-expanded="false">
                                     ...
                                     <li>
                                          ...
                                          <ul aria-expanded="false">
                                                <li><a href="<?php echo e(route('dashboard.hotel.store.inventory.incoming')); ?>">Incoming</a></li>
                                                <li><a href="<?php echo e(route('dashboard.hotel.store.inventory.outgoing')); ?>">Outgoing</a></li>
                                          </ul>
                                     </li>
                                </ul>
                          </li>
...
<!--**********************************
    Sidebar end
***********************************-->
<?php /**PATH C:\Web Development\Backend\Laravel\software-management\software-management\resources\views/dashboard/layouts/navigations/sidebar.blade.php ENDPATH**/ ?>