            ...
            <div class="container-fluid">
                <div class="mt-4 d-flex justify-content-between align-items-center flex-wrap">
                    ...
                    <div class="d-flex align-items-center mb-2">
                        <a href="<?php echo e(route('dashboard.hotel.rooms.create')); ?>" class="btn btn-secondary">+ New Room</a>
                        <div class="newest ms-3">
                            <form id="filter-form" class="d-flex justify-content-between gap-3">
                                <div class="form-group me-2">
                                    <input class="form-control" type="text" placeholder="Search...." name="search"
                                        value="<?php echo e(request()->search); ?>" id="search-input">
                                </div>
                                <select class="default-select room-selection" id="room-selection">
                                    <option name="select_room" value="Newest"
                                        <?php echo e(request()->selection == 'Newest' ? 'selected' : ''); ?>>Newest
                                    </option>
                                    <option name="select_room" value="Oldest"
                                        <?php echo e(request()->selection == 'Oldest' ? 'selected' : ''); ?>>Oldest
                                    </option>
                                    <option name="select_room" value="Available"
                                        <?php echo e(request()->selection == 'Available' ? 'selected' : ''); ?>>
                                        Available</option>
                                    <option name="select_room" value="Occupied"
                                        <?php echo e(request()->selection == 'Occupied' ? 'selected' : ''); ?>>
                                        Occupied</option>
                                </select>
                            </form>
                        </div>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="room-list-bx d-flex align-items-center">
                                                                    ...
                                                                    <div>
                                                                        <span
                                                                            class="fs-16 font-w500 text-nowrap"><?php echo e($room->name); ?></span>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td>
                                                                <span
                                                                    class="fs-16 font-w500 text-nowrap"><?php echo e($room->roomType->name); ?></span>
                                                            </td>
                                                            <td>
                                                                <div class="">
                                                                    <span class="mb-2">Price</span>
                                                                    <span
                                                                        class="font-w500"><?php echo e(currencySymbol()); ?><?php echo e(number_format($room->roomType->rate)); ?><small
                                                            ...
                                                            <td>
                                                                <div>
                                                                    <span
                                                                        class="fs-16 font-w500"><?php echo e($room->description); ?></span>
                                                                </div>
                                                            </td>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            $(document).ready(function() {
                ...
                $('.room-selection').change(function() {
                    ...
                    $.ajax({
                        url: "<?php echo e(route('dashboard.hotel.filter.rooms')); ?>",
                        type: "GET",
                        data: {
...
<?php echo $__env->make('dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Web Development\Backend\Laravel\software-management\software-management\resources\views/dashboard/hotel/room/index.blade.php ENDPATH**/ ?>