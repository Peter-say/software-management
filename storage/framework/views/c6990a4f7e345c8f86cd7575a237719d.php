        ...
        <div class="container-fluid">
            <div class="row page-titles">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="<?php echo e(route('dashboard.hotel.bar-items.index')); ?>">Order Item</a></li>
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form
                            action="<?php echo e(isset($item) ? route('dashboard.hotel.bar-items.update', $item->id) : route('dashboard.hotel.bar-items.store')); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                                    placeholder="Name" value="<?php echo e(old('name', $item->name ?? '')); ?>"
                                                    required>
...
unset($__errorArgs, $__bag); ?>"
                                                    placeholder="Price" value="<?php echo e(old('price', $item->price ?? '')); ?>"
                                                    required>
                                    ...
                                    <div class="card-body">
                                        <div class="form-check mb-3">
                                            <input type="checkbox" class="form-check-input border-danger" id="publish"
                                                ...
                                                <?php echo e(old('publish', $item->is_available ?? false) ? 'checked' : ''); ?>
...
<?php echo $__env->make('dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Web Development\Backend\Laravel\software-management\software-management\resources\views\dashboard\hotel\bar-items\create.blade.php ENDPATH**/ ?>