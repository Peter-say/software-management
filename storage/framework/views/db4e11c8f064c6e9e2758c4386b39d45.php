        ...
        <div class="container-fluid">
            <div class="row page-titles">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item "><a href="<?php echo e(route('dashboard.hotel.expenses.index')); ?>">List</a>

                    </li>
                    <li class="breadcrumb-item"><?php echo e(isset($expense) ? 'Update expense' : 'Create expense'); ?></li>
                </ol>
            </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title"><?php echo e(isset($expense) ? 'Update Expense' : 'Create Expense'); ?></h4>
                    </div>

                    <div class="card-body">
                        <form id="expenseForm"
                            action="<?php echo e(isset($expense) ? route('dashboard.hotel.expenses.update', $expense->id) : route('dashboard.hotel.expenses.store')); ?>"
                            method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <?php if(isset($expense)): ?>
                                <?php echo method_field('PUT'); ?>
                                <input type="hidden" name="expense_id" value="<?php echo e($expense->id); ?>">
                            <?php endif; ?>
                                        ...
                                        <div class="col-xl-3 col-md-4  col-12 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="file" id="uploaded_file" name="uploaded_file"
                                                    class="form-control <?php $__errorArgs = ['uploaded_file'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                                    value="<?php echo e(old('uploaded_file', $expense->uploaded_file ?? '')); ?>">
                                                <?php $__errorArgs = ['uploaded_file'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('note', isset($expense) && $expense->note)); ?></textarea>
                                        ...
                                        <div id="input-template" class="row">
                                            <div class="col-xl-2 col-md-4 col-12 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="description_<?php echo e($key); ?>" name="description[]"
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="col-xl-2 col-md-4 col-12 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <input id="qty_<?php echo e($key); ?>" name="qty[]" type="number" onkeyup="updateAmount(<?php echo e($key); ?>)"
...
unset($__errorArgs, $__bag); ?>"
                                                        placeholder="Qty" value="<?php echo e(old('qty.' . $key, $expenseItem->qty)); ?>">
                                                    <?php $__errorArgs = ['qty'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="col-xl-2 col-md-4 col-12 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" id="rate_<?php echo e($key); ?>" name="rate[]" onkeyup="updateAmount(<?php echo e($key); ?>)"
                                                        inputmode="decimal" min="0" step="any"
...
unset($__errorArgs, $__bag); ?>"
                                                        placeholder="Rate" value="<?php echo e(old('rate.' . $key, $expenseItem->rate)); ?>">
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="col-xl-2 col-md-4 col-12 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" id="amount_<?php echo e($key); ?>" name="amount[]"
...
unset($__errorArgs, $__bag); ?>"
                                                        placeholder="Amount" value="<?php echo e(old('amount.' . $key, $expenseItem->amount)); ?>">
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="col-xl-2 col-md-4 col-12 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" id="unitQty_<?php echo e($key); ?>" name="unit_qty[]" inputmode="decimal" min="0"
                                                        step="any" class="form-control money <?php $__errorArgs = ['unit_qty'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                                        placeholder="Unit Qty" value="<?php echo e(old('unit_qty.' . $key, $expenseItem->unit_qty)); ?>">
...
unset($__errorArgs, $__bag); ?>"
                                                    value="<?php echo e(old('description.0')); ?>" list="items">
                                                <?php $__errorArgs = ['description'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>"
                                                value="<?php echo e(old('description[]')); ?>" list="items">
                                            <?php $__errorArgs = ['description'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mt-4 d-flex justify-content-between align-items-center">
                                ...
                                <div class="d-flex">
                                    <button type="submit" class="btn btn-primary">
                                        <?php echo e(isset($expense) ? 'Update expense' : 'Create expense'); ?>

                                    </button>
                                    <a href="<?php echo e(route('dashboard.hotel.expenses.index')); ?>"
    ...
    <script>
       let inputCounter = <?php echo e(isset($expense->items) ? count($expense->items) : 0); ?>;// Start counter from existing items count
...
<?php echo $__env->make('dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Web Development\Backend\Laravel\software-management\software-management\resources\views\dashboard\hotel\expenses\create.blade.php ENDPATH**/ ?>