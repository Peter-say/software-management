        ...
        <div class="container-fluid">
            <div class="row page-titles">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="<?php echo e(route('dashboard.hotel.bar-items.index')); ?>">Bar
                            Order</a></li>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="guestId">
                                        ...
                                        <?php $__currentLoopData = getModelItems('guests'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $guest): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="guest_<?php echo e($guest->id); ?>">
                                                <i class="fas fa-user"></i> <?php echo e($guest->full_name); ?>

                                            </option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <hr>
                                        <?php $__currentLoopData = getModelItems('walk_in_customers'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="walkin_<?php echo e($customer->id); ?>">
                                                <i class="fas fa-walking"></i> <?php echo e($customer->walkInCustomerInfo()); ?>
                                ...
                                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link text-white" href="#"
                                            data-category="<?php echo e($normalizedCategory); ?>"><?php echo e($category->category); ?></a>
                                    </li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </ul>
                        </div>
                            ...
                            <div class="row">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="outlet_id" required>
                                        ...
                                        <?php $__currentLoopData = getModelItems('bar-outlets'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $outlet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <?php $__currentLoopData = $itemsByCategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category => $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                    ...
                                    ?>
                                    <?php if($items): ?>
                                        <div class="menu-category <?php echo e($normalizedCategory); ?>" style="display: none;">
                                            <section>
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6">
                                                                <div class="card px-4 border shadow-0 mb-4 mb-lg-0">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <a href="#"
                                                                            class="nav-link"><?php echo e($item->name); ?></a>
                                                                        <div class="price-wrap mb-2">
                                                                            <strong
                                                                                class="">$<?php echo e($item->price); ?></strong>
                                                                            <del
                                                                                class="">$<?php echo e($item->discount ?? '0.00'); ?></del>
                                                                        </div>
                                                                        <div
                                                                            ...
                                                                            <a href="#"
                                                                                ...
                                                                                data-item-price="<?php echo e($item->price); ?>">Add
                                                                                to
                                                                                cart</a>
                                                                        </div>
                                                                    </div>
  ...
  <span class="ms-2">X ${item.quantity}</span>
        ...
        `);
                    ...
                    $(document).on('click', '#place-order', function(e) {
                        ...
                        $.ajax({
                            url: '/dashboard/hotel/bar/save-order', // Your backend endpoint for placing orders
                            method: 'POST',
        ...
        <?php echo $__env->make('dashboard.hotel.bar-items.order.notes-modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php $__env->stopSection(); ?>

<?php echo $__env->make('dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Web Development\Backend\Laravel\software-management\software-management\resources\views\dashboard\hotel\bar-items\order\create.blade.php ENDPATH**/ ?>