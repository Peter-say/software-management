                                                        ...
                                                        @foreach ($reservation->guest->restaurantOrders->where('status', 'Open') as $order)
                                                            @if ($order->paymentStatus('pending'))
                                                                <tr>
                                                                    ...
                                                                    <td>{{ currencySymbol() }}{{ number_format($order->total_amount, 2) }}
                                                                    </td>
                                                                </tr>
                                                            @else
                                                                <tr></tr>
                                                ...
                                                <table class="table table-bordered">
                                                    ...
                                                    <tbody>
                                                        @php
                                                            ...
                                                            $restaurantPayments = $reservation->guest->restaurantOrders
                                                                ->where('reservation_id', $reservation->id)
                                                                ->flatMap(fn($order) => $order->payments);

                                                            $barPayments = $reservation->guest->barOrders
                                                                ->where('reservation_id', $reservation->id)
                                                                ->flatMap(fn($order) => $order->payments);
                                                        ...
                                                        @foreach ($paymentChunks as $chunk)
                                                            <tr>
                                                                @foreach ($chunk as $payment)
                                                                    ...
                                                                    <td>{{ currencySymbol() }}{{ number_format($payment->amount, 2) }}
                                                                    </td>
                                                                    <td>
                                                                        <button
