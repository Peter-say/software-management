<?php if($reservation->total_amount > ($reservation->payments() ?? collect())->sum('amount')): ?>
                        ...
                        <input type="hidden" name="amount_due"
                            value="<?php echo e($reservation->total_amount + $reservation->guest->calculateOrderNetTotal() - ($reservation->payments() ?? collect())->sum('amount')); ?>"><?php /**PATH C:\Web Development\Backend\Laravel\software-management\software-management\resources\views\dashboard\general\payment\payable-details.blade.php ENDPATH**/ ?>