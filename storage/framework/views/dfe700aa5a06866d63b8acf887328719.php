<?php $__env->startSection('contents'); ?>
            ...
            <div class="container-fluid">
                <div class="mt-4 d-flex justify-content-between align-items-center flex-wrap">
                    ...
                    <div class="d-flex align-items-center mb-2">
                        <a href="<?php echo e(route('dashboard.hotel.restaurant-items.create')); ?>" class="btn btn-secondary me-2">+
                            New Item</a>
                                    ...
                                    <div class="tab-pane fade active show" id="AllRooms">
                                        <div class="table-responsive">
                                            <table class="table card-table display mb-4 shadow-hover table-responsive-lg"
                                                ...
                                                <tbody>
                                                    <?php $__currentLoopData = $restaurant_items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr>
                                                            <td>
                                                                <div class="form-check style-1">
                                                                    <input class="form-check-input" type="checkbox"
                                                            ...
                                                            <td>
                                                                <div class="d-flex">
                                                                    <!-- Edit Button -->
                                                                    <a href="<?php echo e(route('dashboard.hotel.restaurant-items.edit', $item->id)); ?>"
                                                                    ...
                                                                    <a href="javascript:void(0);"
                                                                        ...
                                                                        onclick="confirmDelete('<?php echo e(route('dashboard.hotel.restaurant-items.destroy', $item->id)); ?>')">
                                        ...
                                        <div class="d-flex justify-content-center">
                                            <?php echo e($restaurant_items->links()); ?>
    ...
    <?php echo $__env->make('dashboard.hotel.restaurant-item.truncate-modal',[ 'items' => $restaurant_items], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>;
...
<?php echo $__env->make('dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Web Development\Backend\Laravel\software-management\software-management\resources\views/dashboard/hotel/restaurant-item/index.blade.php ENDPATH**/ ?>