        ...
        <div class="container-fluid">
            <div class="row page-titles">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('dashboard.hotel.bar-items.index') }}">Order Item</a></li>
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form
                            action="{{ isset($item) ? route('dashboard.hotel.bar-items.update', $item->id) : route('dashboard.hotel.bar-items.store') }}"
                                        ...
                                        <div class="col-lg-6 col-12 mb-3">
                                            <div class="form-group">
                                                ...
                                                <select id="outlet" name="outlet_id"
                                                    ...
                                                    @foreach (getModelItems('bar-outlets') as $outlet)
                                    ...
                                    <div class="card-body">
                                        <div class="form-check mb-3">
                                            <input type="checkbox" class="form-check-input border-danger" id="publish"
                                                ...
                                                {{ old('publish', $item->is_available ?? false) ? 'checked' : '' }}
