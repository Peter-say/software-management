<?php $__env->startSection('contents'); ?>
        ...
        <div class="container-fluid">
            ...
            <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                ...
                <div class="d-flex justify-content-end">
                    <form method="GET" action="<?php echo e(route('dashboard.hotel.store-dashboard')); ?>" class="d-inline">
                        <div class="dropdown">
                    ...
                    <div class="d-flex align-items-center mb-2">
                        <a href="<?php echo e(route('dashboard.hotel.store-items.index')); ?>" class="btn btn-primary me-2">
                            View List</a>
                    </div>
                    <div class="d-flex align-items-center mb-2">
                        <a href="<?php echo e(route('dashboard.hotel.store-items.create')); ?>" class="btn btn-secondary me-2">+
                            Add New Item</a>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-xxl-8 col-xl-8 col-md-12 col-sm-12">
                    <div class="row">
                        <?php $__currentLoopData = $store_item_stats['cards']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body">
                                            <table class="table table-striped mb-0">
                                                ...
                                                <tbody>
                                                    <?php $__currentLoopData = $top_store_items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $top_store_items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr>
                                                            <td><?php echo e($top_store_items->itemCategory->name); ?></td>
                                                            <td><?php echo e(number_format($top_store_items->cost_price)); ?></td>
                                                        </tr>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </tbody>
                                            </table>
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="d-flex d-md-flex d-block align-items-center justify-content-end">
                                <form method="GET" action="<?php echo e(route('dashboard.hotel.store-dashboard')); ?>"
                                    class="d-inline">
                                    <div>
                                        <div class="dropdown">
                                            <button type="button"
    ...
    <?php echo $__env->make('dashboard.chart.store.inventory', ['store_item_chart_data' => $store_item_chart_data], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <script>
...
<?php echo $__env->make('dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Web Development\Backend\Laravel\software-management\software-management\resources\views\dashboard\hotel\store\dashboard.blade.php ENDPATH**/ ?>