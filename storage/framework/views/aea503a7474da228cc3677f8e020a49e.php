                        ...
                        <div class="d-flex justify-content-between">
                            <div>
                                ...
                                <p>
                                    <?php if($order->guest && $order->guest->wallet): ?>
                                        <span><b>₦<?php echo e(number_format($order->guest->wallet->balance, 2, '.', ',')); ?></b></span>
                                    <?php else: ?>
                                        <span><b>₦0.00</b></span>
                                    <?php endif; ?>
                                </p>
                            ...
                            <div>
                                ...
                                <p>
                                    ...
                                    ?>
                                    <b>₦<?php echo e(number_format($totalDue, 2, '.', ',')); ?></b>
                                </p>
                            </div>
                        </div>
...
unset($__errorArgs, $__bag); ?>">
                                ...
                                <?php $__currentLoopData = \App\Constants\CurrencyConstants::CURRENCY_CODES; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $currency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($currency); ?>"
                                        <?php echo e(old('currency', $currency ?? '') == $currency ? 'selected' : ''); ?>>
                                        <?php echo e($currency); ?>
...
<?php /**PATH /home/swifbayo/public_html/software-management/resources/views/dashboard/hotel/bar-items/order/guest-wallet-modal.blade.php ENDPATH**/ ?>