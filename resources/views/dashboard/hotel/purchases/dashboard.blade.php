...
@section('contents')
        ...
        <div class="container-fluid">
            ...
            <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                ...
                <div class="d-flex justify-content-end">
                    <form method="GET" action="{{ route('dashboard.hotel.purchases-dashbaord') }}" class="d-inline">
                        <div class="dropdown">
                    ...
                    <div class="d-flex align-items-center mb-2">
                        <a href="{{ route('dashboard.hotel.purchases.index') }}" class="btn btn-primary me-2">
                            View List</a>
                    </div>
                    <div class="d-flex align-items-center mb-2">
            ...
            <div class="row">
                <div class="col-xxl-8 col-xl-8 col-md-12 col-sm-12">
                    <div class="row">
                        @foreach ($purchase_stats['cards'] as $index => $card)
                                    ...
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body">
                                            <table class="table table-striped mb-0">
                                                ...
                                                <tbody>
                                                    @foreach ($top_purchase as $top_expense)
                                                        <tr>
    ...
    @include('dashboard.chart.purchases.general', ['purchases_chart_data' => $purchase_chart_data])
    <script>
