...
<div class="nav-header">
    <a href="<?php echo e(route('dashboard.home')); ?>" class="brand-logo">
        <?php
        ...
        <img class="img-fluid" id="logo" src="<?php echo e($logoUrl); ?>" alt="Hotel Logo">
                        ...
                        <ul class="contacts">
                            ...
                            <li class="active dlab-chat-user">
                                <div class="d-flex bd-highlight">
                                    <div class="img_cont">
                                        <img src="<?php echo e(asset('dashboard/images/avatar/1.jpg')); ?>"
                            ...
                            <li class="dlab-chat-user">
                                <div class="d-flex bd-highlight">
                                    <div class="img_cont">
                                        <img src="<?php echo e(asset('dashboard/images/avatar/2.jpg')); ?>"
                                            class="rounded-circle user_img" alt="" />
                            ...
                            <li class="dlab-chat-user">
                                <div class="d-flex bd-highlight">
                                    <div class="img_cont">
                                        <img src="<?php echo e(asset('dashboard/images/avatar/3.jpg')); ?>"
                                            class="rounded-circle user_img" alt="" />
                                        <span class="online_icon"></span>
                                    </div>
                                    <div class="user_info">
                            ...
                            <li class="dlab-chat-user">
                                <div class="d-flex bd-highlight">
                                    <div class="img_cont">
                                        <img src="<?php echo e(asset('dashboard/images/avatar/4.jpg')); ?>"
                                            class="rounded-circle user_img" alt="" />
                                        <span class="online_icon offline"></span>
                                    </div>
                                    <div class="user_info">
                            ...
                            <li class="dlab-chat-user">
                                <div class="d-flex bd-highlight">
                                    <div class="img_cont">
                                        <img src="<?php echo e(asset('dashboard/images/avatar/5.jpg')); ?>"
                                            class="rounded-circle user_img" alt="" />
                                        <span class="online_icon offline"></span>
                                    </div>
                                    <div class="user_info">
                            ...
                            <li class="dlab-chat-user">
                                <div class="d-flex bd-highlight">
                                    <div class="img_cont">
                                        <img src="<?php echo e(asset('dashboard/images/avatar/3.')); ?>"
                                            class="rounded-circle user_img" alt="" />
                                        <span class="online_icon"></span>
                                    </div>
                                    <div class="user_info">
...
<?php echo $__env->make('dashboard.layouts.navigations.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Web Development\Backend\Laravel\software-management\software-management\resources\views/dashboard/layouts/navigations/top-nav.blade.php ENDPATH**/ ?>