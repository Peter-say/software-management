        ...
        _createClass(SmartWizard, [
            ...
            },
            {
                ...
                value: function _setEvents() {
                    ...
                    $(this.steps).on("click", function (e) {
                        ...
                        if (
                            _this.options.anchorSettings.anchorClickable ===
                            false
                        ) {
                            return true;
                        } // Get the step index
                        ...
                        if (
                            _this.options.anchorSettings.enableAllAnchors !==
                                false ||
                            _this._isDone(idx)
                        ) {
                            _this._showStep(idx);
            ...
            },
            {
                ...
                value: function _setToolbar() {
                    ...
                    if (
                        this.options.toolbarSettings.toolbarPosition === "none"
                    ) {
                        return true;
            ...
            },
            {
                ...
                value: function _getStepPage(idx) {
                    ...
                    return anchor.length > 0
                        ? this.main.find(anchor.attr("href"))
                        : null;
                },
            },
            {
            ...
            },
            {
                ...
                value: function _doStepAnimation(idx, callback) {
                    ...
                    var animation =
                        this.options.transition.animation.toLowerCase(); // Complete any ongoing animations
                ...
                value: function _setTheme(theme) {
                    this.main
                        .removeClass(function (index, className) {
                            return (
                                className.match(/(^|\s)sw-theme-\S+/g) || []
                            ).join(" ");
                        })
